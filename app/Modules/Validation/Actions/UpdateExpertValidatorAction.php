...
class UpdateExpertValidatorAction
{
     ...
     */
    public function handle(User $user, ExpertValidator $expertValidator, array $attributes, ?Request $request = null): ExpertValidator
    {
        Gate::forUser($user)->authorize('update', $expertValidator);

        $expertValidator->update([
        ...
        $this->activityLogger->log('expert_validator.updated', $user, null, $expertValidator, $this->metadata($expertValidator), $request);

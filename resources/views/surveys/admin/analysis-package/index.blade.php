        ...
        <section class="mt-6 grid gap-6 lg:grid-cols-[1fr_1.25fr]">
            <article class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-5 grid gap-2 sm:grid-cols-2">
                    ...
                    <a href="{{ route('admin.surveys.respondent-package.index', ['survey' => $survey]) }}" class="rounded-md border border-amber-300 bg-white px-4 py-2 text-center text-sm font-semibold text-amber-900 shadow-sm hover:bg-amber-50">Respondent Package</a>

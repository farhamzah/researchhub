...
<head>
    ...
    <title>Survey Unavailable - ResearchHub</title>
...
<body class="bg-gray-50 text-gray-950 antialiased">
    <main class="mx-auto flex min-h-screen max-w-xl items-center px-4 py-12">
        <section class="w-full rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm">
            ...
            <h1 class="mt-3 text-2xl font-semibold">This survey is unavailable</h1>
            <p class="mt-2 text-sm leading-6 text-gray-600">The survey is not currently accepting public responses.</p>
        </section>
    </main>
</body>
</html>

...
class SurveyBuilderWizardTest extends TestCase
{
    ...
    public function test_demo_survey_builder_renders_wizard_steps_with_meaningful_data(): void
    {
        ...
        $this->actingAs($admin)
            ...
            ->assertOk()
            ->assertSeeText('Siapkan Instrumen')
            ...
            ->assertSeeText('Daftar Pertanyaan')
            ->assertSeeText('Option count: 4')
            ->assertSeeText('Kesiapan skoring')
            ->assertSeeText('Pratinjau responden khusus admin')
            ->assertSeeText('Kesiapan validasi ahli')
            ->assertSeeText('Status respons dan analisis')
    ...
    public function test_admin_can_configure_public_survey_intro_from_builder(): void
    {
        ...
        $this->actingAs($owner)
            ->get(route('admin.surveys.builder.index', ['survey' => $survey]))
            ->assertOk()
            ->assertSeeText('Pembuka / Pengantar')
